...
class ClientValidationAdapterTest {
    ...
    private static ClientValidationAdapter clientValidationAdapter;
    ...
    void validateTestGet() {
        ...
        mockBackEnd.enqueue(new MockResponse()
                ...
                .setBody("{\"state\" : \"ok\"}"));
        var response = clientValidationAdapter.testGet();
    ...
    void validateTestPost() {
        ...
        mockBackEnd.enqueue(new MockResponse()
                ...
                .setResponseCode(HttpStatus.OK.value())
                .setBody("{\"state\" : \"ok\"}"));
        var response = clientValidationAdapter.testPost();
